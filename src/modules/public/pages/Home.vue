<template>
  <Navbar>
    <!-- Hero/Slider -->
    <section class="w-full bg-black relative">
      <div class="w-full h-[420px] md:h-[450px] relative">
        <img
          src="/images/HomeImg1.svg"
          alt="CETMAR 41 Cancún"
          class="w-full h-full object-cover"
        />
        <div
          class="absolute inset-0 flex flex-col justify-center items-start md:items-center px-8 md:px-0"
        ...
        >
          <div class="max-w-4xl w-full">
            ...
            <p class="text-lg md:text-2xl font-medium text-white drop-shadow">
        ...
        >
          <span
            class="w-3 h-3 bg-white rounded-full opacity-80 border border-gray-400"
          ></span>
          <span
            class="w-3 h-3 bg-white rounded-full opacity-40 border border-gray-400"
          ></span>
          <span
            class="w-3 h-3 bg-white rounded-full opacity-40 border border-gray-400"
          ></span>
    ...
    <!-- Oferta Educativa -->
    <section class="w-full relative py-14">
      <div class="absolute inset-0 w-full h-full -z-10">
        ...
        >
          <polygon points="0,0 1440,0 1440,500 0,400" fill="#b6f0e7" />
          <polygon points="0,0 1440,0 1440,500 0,180" fill="#fff" />
        </svg>
      </div>
      <div class="max-w-6xl mx-auto relative">
        <h3
          class="text-center text-2xl md:text-3xl font-bold text-blue-900 mb-1"
        >
          NUESTRA OFERTA EDUCATIVA
        </h3>
        <div class="flex justify-center items-center mb-8">
          <span
            class="text-lg md:text-xl font-semibold text-[#1cc6b7] tracking-wide border-b-2 border-[#1cc6b7] px-2"
          >
            CARRERAS TÉCNICAS
          </span>
        </div>
    ...
    <section class="w-full bg-white py-10">
      <div class="max-w-5xl mx-auto">
        <h3
          class="text-center text-xl md:text-2xl font-bold text-blue-900 mb-6"
        >
          NUESTRA INSTITUCIÓN
        </h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <h4 class="font-bold text-lg mb-2">
              Centro de Estudios Tecnologicos del Mar No. 41
            </h4>
            <p class="text-gray-700 text-sm md:text-base">
              ...
              docentes comprometidos, brindamos las herramientas necesarias para
              enfrentar los retos de hoy y construir un mañana exitoso.
            </p>
          </div>
        </div>
        <!-- Galería -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
          <img
            src="/images/HomeImg1.svg"
            alt="Galería 1"
            class="rounded-lg w-full aspect-square object-cover h-48 max-w-xs mx-auto"
          />
          <img
            src="/images/HomeImg2.svg"
            alt="Galería 2"
            class="rounded-lg w-full aspect-square object-cover h-48 max-w-xs mx-auto"
          />
          <img
            src="/images/HomeImg3.svg"
            alt="Galería 3"
            class="rounded-lg w-full aspect-square object-cover h-48 max-w-xs mx-auto"
          />
        </div>
